...
function validateField(field) {
  ...
  if (field.type === "text") {
      ...
      if (!validatePassword(field.value)) {
          showError(field, 'Password must be at least 6 characters and strong.');
          isValid = false;
      }
  }
...
function dark() {
  ...
  if (darkness === "off") {
      body.style.background = "url(./images/healthy-food.jpeg), black";
      ...
      body.style.background = "url(./images/food-healthy.jpg), black";
      body.style.backgroundSize = "cover";
